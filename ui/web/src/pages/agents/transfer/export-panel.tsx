...
export function ExportPanel({ agents, initialAgentId }: ExportPanelProps) {
  ...
  const sections: SectionDef[] = useMemo(() => {
    ...
    return [
      ...
      { id: "skills", labelKey: "transfer.sections.skills", comingSoon: true },
      { id: "mcp", labelKey: "transfer.sections.mcp", comingSoon: true },
      { id: "custom_tools", labelKey: "transfer.sections.customTools", comingSoon: true },
      { id: "cron", labelKey: "transfer.sections.cron", comingSoon: true },
      { id: "permissions", labelKey: "transfer.sections.permissions", comingSoon: true },
